...
class Myclass extends JFrame{
	...
	private void makeUI6() {
		...
		p.add(new JButton("1"));
		p.add(news JButton("Long Button"));
	...
	private void putButton(JPanel p,GridBagConstraints c
			,int x , int y, int w, int h, String s){//grid 적용을 십게하기 위한 함수
		c.gridx = x;
		c.gridy = y;
		c.gridwidth=w;
		c.gridheight=h;
	...
	private void makeUI2() {
		...
		mp3.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(EtchedBorder.LOWERED)
				,"title"));
		p.add(mp3);
